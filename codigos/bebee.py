...
archivo_ReceivedFirst= open("ReceivedFirst_bebee.txt", "w")
archivo_ReceivedLast= open("ReceivedPreLast_bebee.txt", "w")
archivo_UTC= open("UTC_bebee.txt", "w")
archivo_MsgID= open("MsgID_bebee.txt", "w")
...
imap.select('Inbox')
typ, data = imap.search(None,'FROM', 'bebee@hive.bebee.com')
contador=0
