...
archivo_ReceivedFirst= open("ReceivedFirst_playstation.txt", "w")
archivo_ReceivedLast= open("ReceivedPreLast_playstation.txt", "w")
archivo_UTC= open("UTC_playstation.txt", "w")
archivo_MsgID= open("MsgID_playstation.txt", "w")
...
imap.select('Inbox')
typ, data = imap.search(None,'FROM', 'PlayStation@playstationemail.com')
contador=0
