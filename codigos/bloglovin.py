...
archivo_ReceivedFirst= open("ReceivedFirst_bloglovin.txt", "w")
archivo_ReceivedLast= open("ReceivedPreLast_bloglovin.txt", "w")
archivo_UTC= open("UTC_bloglovin.txt", "w")
archivo_MsgID= open("MsgID_bloglovin.txt", "w")
...
imap.select('Inbox')
typ, data = imap.search(None,'FROM', 'info@bloglovin.com')
contador=0
